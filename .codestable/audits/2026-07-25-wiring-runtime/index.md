...
**剩余主动债**：finding-10 仍 partial（ViewMode/SidePanelHost/ToolsDialogs/Hotkey/ActiveQuery 已再拆，MainForm~485、TabContainer~500；完整 SessionOrchestrator deferred）。finding-12 resolved。ApiKey gdk2。
