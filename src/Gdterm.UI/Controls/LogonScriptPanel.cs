...
namespace Gdterm.UI.Controls
{
    ...
    public class LogonScriptPanel : UserControl
    {
        ...
        private LogonScript ShowEditor(LogonScript existing)
        {
            ...
            {
                Location = new Point(100, y), Size = new Size(410, 200),
            ...
            // 步骤操作按钮
            var btnAddStep = new Button { Text = "+", Location = new Point(100, y), Size = new Size(28, 24), FlatStyle = FlatStyle.Flat, BackColor = Color.FromArgb(45, 45, 48), ForeColor = Color.FromArgb(78, 201, 176) };
            btnAddStep.FlatAppearance.BorderSize = 0;
            var btnDelStep = new Button { Text = "−", Location = new Point(132, y), Size = new Size(28, 24), FlatStyle = FlatStyle.Flat, BackColor = Color.FromArgb(45, 45, 48), ForeColor = Color.FromArgb(255, 80, 80) };
            btnDelStep.FlatAppearance.BorderSize = 0;
            var btnUp = new Button { Text = "↑", Location = new Point(170, y), Size = new Size(28, 24), FlatStyle = FlatStyle.Flat, BackColor = Color.FromArgb(45, 45, 48), ForeColor = Color.FromArgb(204, 204, 204) };
            btnUp.FlatAppearance.BorderSize = 0;
            var btnDown = new Button { Text = "↓", Location = new Point(202, y), Size = new Size(28, 24), FlatStyle = FlatStyle.Flat, BackColor = Color.FromArgb(45, 45, 48), ForeColor = Color.FromArgb(204, 204, 204) };
            ...
            var btnOk = new Button { Text = "确定", Size = new Size(80, 28), Location = new Point(340, y), DialogResult = DialogResult.OK, FlatStyle = FlatStyle.Flat, BackColor = Color.FromArgb(0, 122, 204), ForeColor = Color.White };
            var btnCancel = new Button { Text = "取消", Size = new Size(80, 28), Location = new Point(430, y), DialogResult = DialogResult.Cancel, FlatStyle = FlatStyle.Flat, BackColor = Color.FromArgb(60, 60, 60), ForeColor = Color.FromArgb(204, 204, 204) };
        ...
        private LogonStep AddStepDialog()
        {
            var form = new Form
            {
                Text = "添加步骤", Size = new Size(350, 220),
                StartPosition = FormStartPosition.CenterParent,
                BackColor = Color.FromArgb(30, 30, 30), ForeColor = Color.FromArgb(204, 204, 204),
                FormBorderStyle = FormBorderStyle.FixedDialog, MaximizeBox = false, MinimizeBox = false
            };
            var font = new Font("Microsoft YaHei", 9f);
            var cmbType = new ComboBox { Location = new Point(100, 12), Size = new Size(220, 25), DropDownStyle = ComboBoxStyle.DropDownList, BackColor = Color.FromArgb(45, 45, 48), ForeColor = Color.FromArgb(204, 204, 204), FlatStyle = FlatStyle.Flat, Font = font };
            ...
            var numTimeout = new NumericUpDown { Location = new Point(100, 82), Size = new Size(100, 25), Maximum = 60000, Value = 10000, BackColor = Color.FromArgb(45, 45, 48), ForeColor = Color.FromArgb(204, 204, 204), Font = font }; Lbl("超时:", 12, 85, form); form.Controls.Add(numTimeout);

            var btnOk = new Button { Text = "确定", Size = new Size(70, 26), Location = new Point(170, 140), DialogResult = DialogResult.OK, FlatStyle = FlatStyle.Flat, BackColor = Color.FromArgb(0, 122, 204), ForeColor = Color.White };
            var btnCancel = new Button { Text = "取消", Size = new Size(70, 26), Location = new Point(250, 140), DialogResult = DialogResult.Cancel, FlatStyle = FlatStyle.Flat, BackColor = Color.FromArgb(60, 60, 60), ForeColor = Color.FromArgb(204, 204, 204) };
            form.Controls.AddRange(new Control[] { btnOk, btnCancel });
            form.AcceptButton = btnOk; form.CancelButton = btnCancel;
        ...
        private static Label Lbl(string t, int x, int y, Form f) { var l = new Label { Text = t, Location = new Point(x, y + 3), AutoSize = true, Font = new Font("Microsoft YaHei", 9f), ForeColor = Color.FromArgb(204, 204, 204) }; f.Controls.Add(l); return l; }
