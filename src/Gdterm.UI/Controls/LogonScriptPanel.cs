    ...
    public class LogonScriptPanel : UserControl
    {
        ...
        private LogonScript ShowEditor(LogonScript existing)
        {
            ...
            var lvSteps = new ListView
            {
                ...
                BackColor = Color.FromArgb(37, 37, 38), ForeColor = GdtermColorTable.Foreground,
            ...
            var btnUp = new Button { Text = "↑", Location = DpiScale.P(form, 170, y), Size = DpiScale.S(this, 28, 24), FlatStyle = FlatStyle.Flat, BackColor = Color.FromArgb(45, 45, 48), ForeColor = GdtermColorTable.Foreground };
            btnUp.FlatAppearance.BorderSize = 0;
            var btnDown = new Button { Text = "↓", Location = DpiScale.P(form, 202, y), Size = DpiScale.S(this, 28, 24), FlatStyle = FlatStyle.Flat, BackColor = Color.FromArgb(45, 45, 48), ForeColor = GdtermColorTable.Foreground };
        ...
        private LogonStep AddStepDialog()
        {
            ...
            var font = Services.FormFontPolicy.UiFont();
            var cmbType = new ComboBox { Location = DpiScale.P(this, 100, 12), Size = DpiScale.S(this, 220, 25), DropDownStyle = ComboBoxStyle.DropDownList, BackColor = Color.FromArgb(45, 45, 48), ForeColor = GdtermColorTable.Foreground, FlatStyle = FlatStyle.Flat, Font = font };
            ...
            var numTimeout = new NumericUpDown { Location = DpiScale.P(this, 100, 82), Size = DpiScale.S(this, 100, 25), Maximum = 60000, Value = 10000, BackColor = Color.FromArgb(45, 45, 48), ForeColor = GdtermColorTable.Foreground, Font = font }; Lbl("超时:", 12, 85, form); form.Controls.Add(numTimeout);
        ...
        private static TextBox Txt(int x, int y, int w, Form f) { var t = new TextBox { Location = DpiScale.P(f, x, y), Size = DpiScale.S(f, w, 24), BackColor = Color.FromArgb(45, 45, 48), ForeColor = GdtermColorTable.Foreground, Font = new Font("Consolas", 9f), BorderStyle = BorderStyle.FixedSingle }; f.Controls.Add(t); return t; }
