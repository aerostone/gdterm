...
namespace Gdterm.UI.Controls
{
    ...
    public class PortForwardPanel : UserControl
    {
        ...
        private void AddRule()
        {
            ...
            var cmbType = new ComboBox { Location = new Point(110, y - 3), Size = DpiScale.S(this, 250, 25), DropDownStyle = ComboBoxStyle.DropDownList, BackColor = Color.FromArgb(45, 45, 48), ForeColor = Color.FromArgb(204, 204, 204), FlatStyle = FlatStyle.Flat, Font = font };
            ...
            var btnOk = new Button { Text = "确定", Size = DpiScale.S(this, 80, 28), Location = new Point(200, y), DialogResult = DialogResult.OK, FlatStyle = FlatStyle.Flat, BackColor = Color.FromArgb(0, 122, 204), ForeColor = Color.White };
            var btnCancel = new Button { Text = "取消", Size = DpiScale.S(this, 80, 28), Location = new Point(290, y), DialogResult = DialogResult.Cancel, FlatStyle = FlatStyle.Flat, BackColor = Color.FromArgb(60, 60, 60), ForeColor = Color.FromArgb(204, 204, 204) };
